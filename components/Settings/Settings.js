                    ...
                    <Grid alignItems="center" container>
                        <Grid item xs={9}>
                            ...
                            <Typography variant="subtitle1"
                                        color="textSecondary">{i18n.__("Set your preferred settings.")}</Typography>
                        </Grid>
                        <Grid item xs={3}>
                            <Button variant="contained" color="primary" size="large"
                                    onClick={this.saveHandler.bind(this)} fullWidth
                                    disableElevation>{i18n.__("SAVE SETTINGS")}</Button>
                        </Grid>
                    </Grid>
                </Box>
                    ...
                    <Box className="form-container">
                        ...
                        <Box className="single-setting">
                            <Typography variant="subtitle2"
                                        color="textSecondary">{i18n.__("Memorization settings")}</Typography>
                            <Divider variant="fullWidth"/>
                            <FormGroup row>
                                <FormControlLabel control={
                                    <Switch
