            ...
            <Box className="tag-analysis-container">
                ...
                <Grid alignContent="center" container>
                    ...
                    <Grid xs={6} className="text-right" item>
                        <Button color="primary" variant="outlined" onClick={() => { this.openUrl('https://developer.twitter.com/en/docs/tweets/optimize-with-cards/guides/getting-started') }}>{i18n.__("More information")}</Button>
                    </Grid>
                </Grid>
            </Box>
        );
