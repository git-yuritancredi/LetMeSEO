        ...
        return (
            <Box className="tag-analysis-container">
                <Typography variant="h5" color="textPrimary" className="title-tag">
                    { this.socialSet() ? <CheckCircleIcon color="primary" /> : <WarningIcon color="secondary" /> } {i18n.__("Open Graph tags")}
                ...
                <Grid container alignItems="center">
                    <Grid xs={8} item>
                        <Typography variant="subtitle1" className="description-tag" color="textSecondary">
                            {i18n.__("Open Graph meta tags are snippets of code that control how URLs are displayed when shared on social media.")} <br />
                    ...
                    <Grid xs={4} className="text-right" item>
                        <Button color="primary" variant="outlined" onClick={() => { this.openUrl('https://ogp.me/') }}>{i18n.__("More information")}</Button>
                    </Grid>
                </Grid>
            </Box>
        );
